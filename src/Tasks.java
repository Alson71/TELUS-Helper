...
public class Tasks extends JFrame implements ActionListener {
    ...
    public Tasks() {
        ...
        for(i = 0; i < 22; ++i) {
            ...
            button[i].setBounds(increment, 325, 45, 30);
            button[i].addActionListener(this);
            add(button[i]);

            negativeButton[i] = new JButton("-");
            negativeButton[i].setBounds(increment, 383, 45, 30);
            ...
            field[i].setBounds(increment, 355, 45, 30);
        ...
        for(i = 22; i < 44; ++i) {
            button[i] = new JButton("+");
            button[i].setFont(new Font("Times New Roman", Font.BOLD, 20));
            button[i].setBounds(increment, 465, 45, 30);
            button[i].addActionListener(this);
            add(button[i]);

            negativeButton[i] = new JButton("-");
            negativeButton[i].setBounds(increment, 523, 45, 30);
            negativeButton[i].setFont(new Font("Times New Roman", Font.BOLD, 25));
            negativeButton[i].addActionListener(this);
            add(negativeButton[i]);
            ...
            field[i] = new JTextField(16);
            field[i].setHorizontalAlignment(0);
            field[i].setBounds(increment, 495, 45, 30);
            field[i].setFont(new Font("Times New Roman", Font.BOLD, 25));
            field[i].setEditable(false);
            field[i].setText(String.valueOf(number[i]));
            add(field[i]);
        ...
        for(i = 44; i < 66; ++i) {
            button[i] = new JButton("+");
            button[i].setFont(new Font("Times New Roman", Font.BOLD, 20));
            button[i].setBounds(increment, 605, 45, 30);
            button[i].addActionListener(this);
            add(button[i]);

            negativeButton[i] = new JButton("-");
            negativeButton[i].setBounds(increment, 663, 45, 30);
            negativeButton[i].setFont(new Font("Times New Roman", Font.BOLD, 25));
            negativeButton[i].addActionListener(this);
            add(negativeButton[i]);
            ...
            field[i] = new JTextField(16);
            field[i].setHorizontalAlignment(0);
            field[i].setBounds(increment, 635, 45, 30);
            field[i].setFont(new Font("Times New Roman", Font.BOLD, 25));
            field[i].setEditable(false);
            field[i].setText(String.valueOf(number[i]));
            add(field[i]);
        ...
        for(i = 66; i < 69; ++i) {
            button[i] = new JButton("+");
            button[i].setFont(new Font("Times New Roman", Font.BOLD, 20));
            button[i].setBounds(increment, 725, 45, 30);
            button[i].addActionListener(this);
            add(button[i]);

            negativeButton[i] = new JButton("-");
            negativeButton[i].setBounds(increment, 783, 45, 30);
            negativeButton[i].setFont(new Font("Times New Roman", Font.BOLD, 25));
            negativeButton[i].addActionListener(this);
            add(negativeButton[i]);
            ...
            field[i] = new JTextField(16);
            field[i].setHorizontalAlignment(0);
            field[i].setBounds(increment, 755, 45, 30);
            field[i].setFont(new Font("Times New Roman", Font.BOLD, 25));
            field[i].setEditable(false);
            field[i].setText(String.valueOf(number[i]));
            add(field[i]);
