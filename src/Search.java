...
public class Search extends JFrame implements ActionListener{
    ...
    public Search(){
        ...
        getContentPane().setBackground(new Color(0x8FD511));
        ...
        titleLabel = new JLabel("Search 2.0");
        titleLabel.setBounds(360,0,300,40);
        titleLabel.setFont(new Font("Times New Roman",Font.BOLD,20));
        titleLabel.setForeground(new Color(0x0E0EE7));
